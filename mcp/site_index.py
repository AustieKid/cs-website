...
class SiteIndex:
            ...
            entity.update(
                {
                    ...
                    "program_level": collapse_whitespace(front_matter.get("program_level")) or None,
                    "requirement_summary": collapse_whitespace(front_matter.get("requirement_summary")) or None,
                    "prerequisite_summary": collapse_whitespace(front_matter.get("prerequisite_summary")) or None,
                    "requirement_keywords": [collapse_whitespace(value) for value in ensure_list(front_matter.get("requirement_keywords")) if collapse_whitespace(value)],
    ...
    def get_program(self, program_slug_or_name: str) -> dict[str, Any] | None:
        ...
        return {
            ...
            "requirement_summary": program.get("requirement_summary"),
            "prerequisite_summary": program.get("prerequisite_summary"),
            "requirement_keywords": program.get("requirement_keywords", []),
